...
// Function to calculate the total change in profits
function calculateTotalChange(finances) {
  var totalChange = 0;
...
// Function to find the greatest decrease in losses
function findGreatestDecrease(finances) {
  ...
  return { date: greatestDecreaseDate, amount: greatestDecrease };
}

// Function to calculate the average change in profits
...
// Function to get the total number of months
function getTotalMonths(finances) {
...
var totalChange = calculateTotalChange(finances);
